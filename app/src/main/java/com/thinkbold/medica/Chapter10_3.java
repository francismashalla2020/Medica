...
public class Chapter10_3 extends AppCompatActivity {
    Button buttonProceed, buttonR;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chapter10_3);
        ...
        menusT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu popupMenu = new PopupMenu(Chapter10_3.this, v);
                popupMenu.setOnMenuItemClickListener(Chapter10_3.this::onMenuItemClick);
