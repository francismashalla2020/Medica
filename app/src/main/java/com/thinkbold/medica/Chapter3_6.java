...
public class Chapter3_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chapter3_6);
        ...
        menusT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu popupMenu = new PopupMenu(Chapter3_6.this, v);
                popupMenu.setOnMenuItemClickListener(Chapter3_6.this::onMenuItemClick);
