...
public class Chapter5_7 extends AppCompatActivity {
    Button buttonProceed, buttonR;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chapter5_7);
        ...
        menusT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu popupMenu = new PopupMenu(Chapter5_7.this, v);
                popupMenu.setOnMenuItemClickListener(Chapter5_7.this::onMenuItemClick);
