...
public class Chapter9_3 extends AppCompatActivity {
    Button buttonProceed, buttonR;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chapter9_3);
        ...
        menusT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PopupMenu popupMenu = new PopupMenu(Chapter9_3.this, v);
                popupMenu.setOnMenuItemClickListener(Chapter9_3.this::onMenuItemClick);
